...
class _CompanyDetailsScreenState extends BaseState<CompanyDetailsScreen> {
  ...
  Future<String> bookNow() async {
    ...
    if (gro.objList.length > 0) {
      ...
      Navigator.of(context)
        ...
        setState(() {
          this.resetSelectedTimeslot = true;
        });
  ...
  Widget build(BuildContext context) {
    ...
    Widget bookingFilter = BookingFilter(this._company, this._form,
        this.setupBookingFilterSelection, this.resetSelectedTimeslot);

    if (this.resetSelectedTimeslot) this.resetSelectedTimeslot = false;
